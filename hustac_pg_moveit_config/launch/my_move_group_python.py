...
class MoveGroupPythonIntefaceTutorial(object):
  ...
  def go_to_pose_goal(self):
    ...
    pose_goal.position.x = 0.342
    pose_goal.position.y = -0.552
...
def main():
  try:
    ...
    tutorial.go_to_pose_named('left_arm_home', True)
    rospy.sleep(0.2)
    tutorial.go_to_pose_named('left_arm_pose', True)
    rospy.sleep(0.2)
